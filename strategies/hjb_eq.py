...
from trading.spot import spot_positions, spot_open_orders
from calc.spread import volatility
import numpy as np
...
def hjb(coin, address, info, exchange):
    ...
    spot_res = spot_positions(address, info)
    ...
    user_orders = spot_open_orders(info, address)
